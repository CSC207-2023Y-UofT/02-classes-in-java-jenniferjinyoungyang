...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two parameters, both of which are strings.
     *
     * @param first_name a first string for this Silly instance's name.
     * @param second_name a second string for this Silly instance's name.
     */
    public Silly(String first_name, String second_name) {
